...
public final class MongoDbProvider implements NoSqlProvider<XNMongoDbConnection> {
    ...
    private MongoDbProvider(final DB database, final WriteConcern writeConcern, final String collectionName,
                            final String description, String clientName) {
    ...
    @Override
    public XNMongoDbConnection getConnection() {
        return new XNMongoDbConnection(this.database, this.writeConcern, this.collectionName, this.clientName);
    }
    ...
    public static MongoDbProvider createNoSqlProvider(
        ...
        return new MongoDbProvider(database, writeConcern, collectionName, description, clientName);
    }
