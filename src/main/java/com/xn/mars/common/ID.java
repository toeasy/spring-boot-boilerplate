 ...
 * 生成分布式全局唯一id，可排序
 */
public class ID implements Comparable<ID>, java.io.Serializable {
    ...
    private static final Logger LOGGER = Logger.getLogger("com.xn.mars.common.ID");
     ...
     *
     * @param s a potential ID as a String.
    ...
    public static void main(String[] args) {
        System.out.println(new ID().toHexString());
        System.out.println(new ID().toHexString());
        System.out.println(new ID().toHexString());
    }
}